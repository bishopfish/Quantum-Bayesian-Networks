...
# NOTE: This version of QISKIT is now depecrated. 
...
class network:
    ...
    def quantum_circuit(self, draw=True):
        ...
        if draw:
            print(qc)
        # Calculate child probabilities through simulation.
        sim = qiskit.execute(qc, qiskit.BasicAer.get_backend('qasm_simulator'))
